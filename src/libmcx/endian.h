...
#define cvt_le64toh(x) ((sparse_force u64)(le64)x)
#define cvt_htole16(x) ((sparse_force le16)(u16)x)
#define cvt_htole32(x) ((sparse_force le32)(u32)x)
#define cvt_htole64(x) ((sparse_force le64)(u64)x)
#define cvt_be16toh(x) (__builtin_bswap16((sparse_force u16)(be16)x))
#define cvt_be32toh(x) (__builtin_bswap32((sparse_force u32)(be32)x))
#define cvt_be64toh(x) (__builtin_bswap64((sparse_force u64)(be64)x))
#define cvt_htobe16(x) ((sparse_force be16)__builtin_bswap16(x))
#define cvt_htobe32(x) ((sparse_force be32)__builtin_bswap32(x))
#define cvt_htobe64(x) ((sparse_force be64)__builtin_bswap64(x))
...
#define cvt_le16toh(x) (__builtin_bswap16((sparse_force u16)(le16)x))
#define cvt_le32toh(x) (__builtin_bswap32((sparse_force u32)(le32)x))
#define cvt_le64toh(x) (__builtin_bswap64((sparse_force u64)(le64)x))
#define cvt_htole16(x) ((sparse_force le16)__builtin_bswap16(x))
#define cvt_htole32(x) ((sparse_force le32)__builtin_bswap32(x))
#define cvt_htole64(x) ((sparse_force le64)__builtin_bswap64(x))
#define cvt_be16toh(x) ((sparse_force u16)(be16)x)
#define cvt_be32toh(x) ((sparse_force u32)(be32)x)
#define cvt_be64toh(x) ((sparse_force u64)(be64)x)
#define cvt_htobe16(x) ((sparse_force be16)(u16)x)
#define cvt_htobe32(x) ((sparse_force be32)(u32)x)
#define cvt_htobe64(x) ((sparse_force be64)(u64)x)
